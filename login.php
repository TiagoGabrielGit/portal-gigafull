...
if (isset($_POST['email']) || isset($_POST['senha'])) {
  ...
  if (strlen($_POST['email']) == 0) {
    ...
    if ($quantidade == 1) {
      ...
      $insert_log = "INSERT INTO portal_log_acesso (usuario_id, ip_address, horario) VALUES ('$usuario_id', '$ip_address', NOW())";
...
<head>
  ...
  <title>Login - Gigafull Portal</title>
